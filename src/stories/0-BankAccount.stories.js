...
export const RW = () => (
  <div className={styles.rwContainer}>
    <BankAccount
      ...
      account_number={text('Account Number', '8086005300000307')}
      bank_name={text('Bank Name', 'Bank BRI (Virtual Account)')}
      bank_icon={text('Bank Icon Src', 'https://cf.shopee.co.id/file/b18d8b4fff42c4db820b085f3a21becc')}
      allow_copy={boolean('Allow Copy', true)}
      extra_labels={array('Extra Notes', [
        '10 minutes to verify payment',
        'To ensure Virtual Account number remains the same, please complete payment before creating another order with Virtual Account.',
...
PC.story = {
  parameters: {
    design: {
      type: 'figma',
      url: 'https://www.figma.com/file/EifHCVZrwvbYuNADNbuRsf/Virtual-Account?node-id=61%3A286',
    },
  },
};
...
RW.story = {
  parameters: {
    ...
    design: {
      type: 'figma',
      url: 'https://www.figma.com/file/EifHCVZrwvbYuNADNbuRsf/Virtual-Account?node-id=63%3A279',
    },
  },
};
